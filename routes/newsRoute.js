...
router.get("/api/news-category", newsController.get_news_category);
...
router.get("/api/category/news/:category", newsController.get_news_categorys);
router.get("/api/search/news", newsController.news_search);

router.get(
  "/api/category-article-get/:category",
  newsController.category_article_get
);
